...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, user_component_1.UserComponent, home_component_1.HomeComponent, country_component_1.CountryComponent, article_component_1.ArticleComponent, admin_component_1.AdminComponent],
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' }, user_service_1.UserService, country_service_1.CountryService, article_service_1.ArticleService, admin_service_1.AdminService],
