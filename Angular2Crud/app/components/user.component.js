...
var UserComponent = (function () {
    ...
    UserComponent.prototype.ngOnInit = function () {
        this.userFrm = this.fb.group({
            ...
            Price: [''],
            AlbumArtUrl: ['', forms_1.Validators.required],
            Artist: ['']
        });
        this.LoadUsers();
    };
    ...
    UserComponent.prototype.editUser = function (AlbumId) {
        this.dbops = enum_1.DBOperation.update;
        this.SetControlsState(true);
        this.modalTitle = "Edit User";
        this.modalBtnTitle = "Update";
        this.user = this.users.filter(function (x) { return x.AlbumId == AlbumId; })[0];
        this.userFrm.setValue(this.user);
        this.modal.open();
    };
    UserComponent.prototype.deleteUser = function (AlbumId) {
    ...
    UserComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            ...
            case enum_1.DBOperation.update:
                this._userService.put(global_1.Global.BASE_USER_ENDPOINT, formData._value.AlbumId, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.delete:
                this._userService.delete(global_1.Global.BASE_USER_ENDPOINT, formData._value.AlbumId).subscribe(function (data) {
                    if (data == 1) {
